...
export default async function Project({ params }: ProjectPageProps) {
  ...
  return (
    <article className="relative max-w-3xl mx-auto py-6 lg:py-10 px-0 md:px-8">
      <Link
        href="/projects"
        className={cn(
      ...
      <div className="w-full bg-muted py-8 px-4 md:py-10 md:px-12 md:my-8 md:rounded-3xl">
        <div>
          <time
          ...
          <div className="mt-4 flex space-x-4">
            ...
            >
              ...
              <div className="flex-1 text-left leading-tight">
                <p className="font-medium">{"Mohd Sohail Ansari"}</p>
