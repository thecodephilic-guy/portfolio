...
<ProTip>
Here’s a dedicated blog on
<a href='/blogs/jsx-is-not-html-inside-javascript' target='_blank' className='font-medium text-primary underline underline-offset-4 hover:text-primary/80 transition-colors'>JSX</a>
</ProTip>
